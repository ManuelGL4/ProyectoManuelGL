...
/**
 *  \file       averias_contact.php
 *  \ingroup    averiasreparaciones
 *  \brief      Tab for contacts linked to Averias
 */
...
$hookmanager->initHooks(array('averiascontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->averiasreparaciones->averias->write;
...
$title = $langs->trans('Averias')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
