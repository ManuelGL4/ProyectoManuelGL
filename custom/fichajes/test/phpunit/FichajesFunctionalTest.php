...
/**
 * \file    test/phpunit/FichajesFunctionalTest.php
 * \ingroup fichajes
 ...
 *
 * @package Testfichajes
 */
class FichajesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/fichajes/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('fichajes/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/fichajes/admin/about.php');
		$this->authenticate();
		return $this->assertContains('fichajes/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('fichajeswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFichajes_FichajesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFichajes_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
