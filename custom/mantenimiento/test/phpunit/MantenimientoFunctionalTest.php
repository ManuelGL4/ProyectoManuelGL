...
/**
 * \file    test/phpunit/MantenimientoFunctionalTest.php
...
/**
 * Class MantenimientoFunctionalTest
 *
 ...
 */
class MantenimientoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMantenimiento')->click();
		} else {
			// Disable the module
			$this->byHref('modMantenimiento')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mantenimiento/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mantenimiento/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mantenimiento/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mantenimiento/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mantenimientowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMantenimiento_MantenimientoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMantenimiento_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
