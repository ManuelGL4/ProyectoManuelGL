...
/**
 *  \file       factura_origen_contact.php
 *  \ingroup    ventas
 *  \brief      Tab for contacts linked to Factura_origen
 */
...
$hookmanager->initHooks(array('factura_origencontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->ventas->factura_origen->write;
...
$title = $langs->trans('Factura_origen')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
