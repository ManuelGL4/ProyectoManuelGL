...
/**
 *  \file       informes_contact.php
 *  \ingroup    mantenimiento
 *  \brief      Tab for contacts linked to Informes
 */
...
$hookmanager->initHooks(array('informescontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->mantenimiento->informes->write;
...
$title = $langs->trans('Informes')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
