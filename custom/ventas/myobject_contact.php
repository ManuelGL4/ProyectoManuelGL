...
/**
 *  \file       ventas/myobject_contact.php
 *  \ingroup    ventas
...
dol_include_once('/ventas/class/myobject.class.php');
dol_include_once('/ventas/lib/ventas_myobject.lib.php');
...
$permission = $user->rights->ventas->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/ventas/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
