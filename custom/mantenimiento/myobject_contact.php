...
/**
 *  \file       mantenimiento/myobject_contact.php
...
dol_include_once('/mantenimiento/class/myobject.class.php');
dol_include_once('/mantenimiento/lib/mantenimiento_myobject.lib.php');
...
$permission = $user->rights->mantenimiento->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/mantenimiento/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
