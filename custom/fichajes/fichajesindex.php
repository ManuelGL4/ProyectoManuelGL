...
/**
 *	\file       fichajes/fichajesindex.php
 *	\ingroup    fichajes
...
// Security check
// if (! $user->rights->fichajes->myobject->read) {
// 	accessforbidden();
// }
...
llxHeader("", $langs->trans("FichajesArea"));

print load_fiche_titre($langs->trans("FichajesArea"), '', 'fichajes.png@fichajes');
...
if (! empty($conf->fichajes->enabled) && $user->rights->fichajes->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."fichajes_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
