...
if ($result) {
	...
	print_barre_liste($langs->trans("Listado de eventos de seguridad - ERPNET v.2 - (C) DELTANET-SI"), $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $center, $num, $nbtotalofrecords, 'setup', 0, '', '', $limit);
