...
/**
 *  \file       orden_de_trabajo_agenda.php
 *  \ingroup    produccion
 *  \brief      Tab of events on Orden_de_Trabajo
 */
...
$hookmanager->initHooks(array('orden_de_trabajoagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnOrden_de_Trabajo"), '', '');
