...
/**
 *  \file       orden_de_trabajo_contact.php
 *  \ingroup    produccion
 *  \brief      Tab for contacts linked to Orden_de_Trabajo
 */
...
$hookmanager->initHooks(array('orden_de_trabajocontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->produccion->orden_de_trabajo->write;
...
$title = $langs->trans('Orden_de_Trabajo')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
