...
/**
 * \file    test/phpunit/RecursosFunctionalTest.php
 * \ingroup recursos
 ...
 *
 * @package Testrecursos
 */
class RecursosFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/recursos/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('recursos/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/recursos/admin/about.php');
		$this->authenticate();
		return $this->assertContains('recursos/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('recursoswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modRecursos_RecursosTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modRecursos_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
