	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if ($conf->expedition->dir_output) {
			...
			if (file_exists($dir)) {
				...
				$pdf->SetXY(-130, -51); // Ajusta estos valores según sea necesario
				...
				$pdf->SetXY(-130, -46); // Ajusta estos valores según sea necesario
				...
				$pdf->SetXY(-130, -41); // Ajusta estos valores según sea necesario
