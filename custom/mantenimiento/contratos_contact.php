...
/**
 *  \file       contratos_contact.php
 *  \ingroup    mantenimiento
 *  \brief      Tab for contacts linked to Contratos
 */
...
$hookmanager->initHooks(array('contratoscontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->mantenimiento->contratos->write;
...
$title = $langs->trans('Contratos')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
