...
function project_prepare_head(Project $project)
{
	...
	$head[$h][0] = DOL_URL_ROOT.'/projet/materials.php?id='.$project->id;
	$head[$h][1] = "Materiales y operaciones";
	$head[$h][2] = 'materials';
	$h++;

	$head[$h][0] = DOL_URL_ROOT.'/projet/other_data.php?id='.$project->id;
	$head[$h][1] = "Resumen";
	$head[$h][2] = 'other_data';
	$h++;
	...
	$head[$h][0] = DOL_URL_ROOT.'/projet/certificaciones.php?id='.$project->id;
	$head[$h][1] = "Certificaciones";
	$head[$h][2] = 'certificaciones';
	$h++;
