...
/**
 * \file    test/phpunit/DocumentosDriveFunctionalTest.php
...
/**
 * Class DocumentosDriveFunctionalTest
 *
 ...
 *
 * @package Testdocumentosdrive
 */
class DocumentosDriveFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDocumentosDrive')->click();
		} else {
			// Disable the module
			$this->byHref('modDocumentosDrive')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/documentosdrive/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('documentosdrive/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/documentosdrive/admin/about.php');
		$this->authenticate();
		return $this->assertContains('documentosdrive/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('documentosdrivewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDocumentosDrive_DocumentosDriveTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDocumentosDrive_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
