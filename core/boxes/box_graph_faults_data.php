...
/**
 * Class to manage the box to faults data
 */
class box_graph_faults_data extends ModeleBoxes
{
	public $boxcode = "faultsdata";
	public $boximg = "object_fault";
	public $boxlabel = "BoxFaultsData";
	public $depends = array("faults");
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("Datos averías", $max);
