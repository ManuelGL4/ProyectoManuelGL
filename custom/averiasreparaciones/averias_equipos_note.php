...
/**
 *  \file       averias_equipos_note.php
 *  \ingroup    averiasreparaciones
 *  \brief      Tab for notes on Averias_equipos
 */
...
$hookmanager->initHooks(array('averias_equiposnote', 'globalcard')); // Note that conf->hooks_modules contains array
