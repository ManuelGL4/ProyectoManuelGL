...
/**
 *  \file       averias_softwares_note.php
 *  \ingroup    averiasreparaciones
 *  \brief      Tab for notes on Averias_softwares
 */
...
$hookmanager->initHooks(array('averias_softwaresnote', 'globalcard')); // Note that conf->hooks_modules contains array
