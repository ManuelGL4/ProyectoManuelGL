...
/**
 *  \file       averias_equipos_agenda.php
 *  \ingroup    averiasreparaciones
 *  \brief      Tab of events on Averias_equipos
 */
...
$hookmanager->initHooks(array('averias_equiposagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnAverias_equipos"), '', '');
