...
/**
 *  \file       averias_ofertas_note.php
 *  \ingroup    averiasreparaciones
 *  \brief      Tab for notes on Averias_ofertas
 */
...
$hookmanager->initHooks(array('averias_ofertasnote', 'globalcard')); // Note that conf->hooks_modules contains array
