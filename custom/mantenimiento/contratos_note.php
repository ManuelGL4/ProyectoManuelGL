...
/**
 *  \file       contratos_note.php
 *  \ingroup    mantenimiento
 *  \brief      Tab for notes on Contratos
 */
...
$hookmanager->initHooks(array('contratosnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissionnote = $user->rights->mantenimiento->contratos->write; // Used by the include of actions_setnotes.inc.php
$permissiontoadd = $user->rights->mantenimiento->contratos->write; // Used by the include of actions_addupdatedelete.inc.php
...
$help_url = '';
llxHeader('', $langs->trans('Contratos'), $help_url);
