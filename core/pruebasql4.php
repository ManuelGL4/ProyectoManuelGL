<?php
    ...
    $ruta = "archivosImportacion/CF-Delegaciones Proveedores.xlsx";
    ...
    //LEEMOS EL EXCEL
    //CADAD FILA
    for ($fila = 11; $fila <= $filamasalta; $fila++) {
    ...
    header('Content-Disposition: attachment; filename="delegacionesPro.sql"');
