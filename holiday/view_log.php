...
if (empty($search_validator)&&($user_is_admin==1)) {
    $search_validator = $user_id;
}
...
if (!empty($arrayfields['cpl.fk_user_action']['checked'])) {
	...
	print $form->select_dolusers($search_validator, "search_validator", 1, "", $disabled, $valideurarray, '', 0, 0, 0, $morefilter, 0, '', 'maxwidth200');
	print '</td>';
}
