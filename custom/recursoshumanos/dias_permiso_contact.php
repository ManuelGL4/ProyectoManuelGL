...
/**
 *  \file       dias_permiso_contact.php
 *  \ingroup    recursoshumanos
 *  \brief      Tab for contacts linked to Dias_permiso
 */
...
$hookmanager->initHooks(array('dias_permisocontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->recursoshumanos->dias_permiso->write;
...
$title = $langs->trans('Dias_permiso')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
