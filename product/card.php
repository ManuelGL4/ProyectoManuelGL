...
if ($action != 'create' && $action != 'edit') {
	...
	if (empty($reshook)) {
		if ($usercancreate) {
			print '<a class="butAction" href="../barcode/printsheet.php?idproducto='.$object->id.'" target="_blank">'.$langs->trans("Imprimir código de barras").'</a>';
...
if ($action != 'create' && $action != 'edit' && $action != 'delete') {
	...
	// SCRIPT JS PARA OCULTAR LOS CAMPOS DE TIEMPO, YA QUE ESTOS HAN SIDO MOVIDOS A SU PROPIA PESTAÑA
	// SOLO APARECERÁN EN LOS FORMULARIOS DE MODIFICACIÓN

	echo '<script>

		var elemento = document.getElementById("product_extras_tiempo_min_est_1");
		var padre = elemento.parentNode;
		padre.style.display = "none";
		var sigElemento = padre.nextElementSibling;
		sigElemento.style.display = "none";

		var elemento = document.getElementById("product_extras_tiempo_med_est_1");
		var padre = elemento.parentNode;
		padre.style.display = "none";
		var sigElemento = padre.nextElementSibling;
		sigElemento.style.display = "none";

		var elemento = document.getElementById("product_extras_tiempo_max_est_1");
		var padre = elemento.parentNode;
		padre.style.display = "none";
		var sigElemento = padre.nextElementSibling;
		sigElemento.style.display = "none";

		var elemento = document.getElementById("product_extras_tiempo_min_real_1");
		var padre = elemento.parentNode;
		padre.style.display = "none";
		var sigElemento = padre.nextElementSibling;
		sigElemento.style.display = "none";

		var elemento = document.getElementById("product_extras_tiempo_med_real_1");
		var padre = elemento.parentNode;
		padre.style.display = "none";
		var sigElemento = padre.nextElementSibling;
		sigElemento.style.display = "none";

		var elemento = document.getElementById("product_extras_tiempo_max_real_1");
		var padre = elemento.parentNode;
		padre.style.display = "none";
		var sigElemento = padre.nextElementSibling;
		sigElemento.style.display = "none";
