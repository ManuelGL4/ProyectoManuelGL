...
/**
 * \file    test/phpunit/CalidadFunctionalTest.php
 * \ingroup calidad
 ...
 * @package Testcalidad
 */
class CalidadFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/calidad/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('calidad/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/calidad/admin/about.php');
		$this->authenticate();
		return $this->assertContains('calidad/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('calidadwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCalidad_CalidadTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCalidad_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
