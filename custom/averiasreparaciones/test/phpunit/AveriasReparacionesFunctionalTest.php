...
/**
 * \file    test/phpunit/AveriasReparacionesFunctionalTest.php
...
/**
 * Class AveriasReparacionesFunctionalTest
 *
 ...
 *
 * @package Testaveriasreparaciones
 */
class AveriasReparacionesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAveriasReparaciones')->click();
		} else {
			// Disable the module
			$this->byHref('modAveriasReparaciones')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/averiasreparaciones/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('averiasreparaciones/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/averiasreparaciones/admin/about.php');
		$this->authenticate();
		return $this->assertContains('averiasreparaciones/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('averiasreparacioneswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAveriasReparaciones_AveriasReparacionesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAveriasReparaciones_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
