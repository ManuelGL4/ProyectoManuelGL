<?php
    ...
    $ruta = "archivosImportacion/CF-Contactos Proveedores.xlsx";
    ...
    for ($fila = 600; $fila <= $filamasalta; $fila++) {
        ...
        $contenido.= "SET @iduser = (SELECT se.fk_object FROM khns_societe_extrafields se INNER JOIN khns_societe s ON s.rowid = se.fk_object WHERE id_khonos = ".$datos[0]." AND s.fournisseur = 1)//";
        $contenido.= "\r\n";
    ...
    header('Content-Disposition: attachment; filename="Contactos-PRO.sql"');
