...
/**
 *  \file       produccion/myobject_contact.php
 *  \ingroup    produccion
...
dol_include_once('/produccion/class/myobject.class.php');
dol_include_once('/produccion/lib/produccion_myobject.lib.php');
...
$permission = $user->rights->produccion->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/produccion/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
