...
/**
 * \file    test/phpunit/ChronoFunctionalTest.php
 * \ingroup chrono
 ...
 * @package Testchrono
 */
class ChronoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/chrono/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('chrono/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/chrono/admin/about.php');
		$this->authenticate();
		return $this->assertContains('chrono/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('chronowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modChrono_ChronoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modChrono_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
