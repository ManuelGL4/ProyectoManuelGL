...
/**
 * \file    test/phpunit/VentasFunctionalTest.php
 * \ingroup ventas
 ...
 * @package Testventas
 */
class VentasFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/ventas/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('ventas/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/ventas/admin/about.php');
		$this->authenticate();
		return $this->assertContains('ventas/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('ventaswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modVentas_VentasTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modVentas_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
