...
class modOpenSurvey extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$r = 0;
		$this->menu[$r] = array(
			'fk_menu'=>'fk_mainmenu=recursoshumanos', // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',
			'titre'=>'Survey',
			'prefix' => img_picto('', $this->picto, 'class="paddingright pictofixedwidth"'),
			'mainmenu'=>'recursoshumanos',
			'leftmenu'=>'opensurvey',
			'url'=>'/opensurvey/index.php?mainmenu=recursoshumanos&leftmenu=opensurvey',
			'langs'=>'opensurvey',
			'position'=>200,
		...
		$this->menu[$r] = array(
			'fk_menu'=>'fk_mainmenu=recursoshumanos,fk_leftmenu=opensurvey', // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',
			'titre'=>'NewSurvey',
			'mainmenu'=>'recursoshumanos',
