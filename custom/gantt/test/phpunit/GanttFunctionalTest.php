...
/**
 * \file    test/phpunit/GanttFunctionalTest.php
 * \ingroup gantt
 ...
 * @package Testgantt
 */
class GanttFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/gantt/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gantt/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gantt/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gantt/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('ganttwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGantt_GanttTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGantt_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
